...
public class SpeechLogDao {
	 ...
	 */
	public SpeechLog get(Serializable id) throws DataAccessException {
		try {
			return (SpeechLog)getSession().get(SpeechLog.class, id);
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public SpeechLog get(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (SpeechLog)getSession().get(SpeechLog.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public SpeechLog load(Serializable id) throws DataAccessException {
		try {
			return (SpeechLog)getSession().load(SpeechLog.class, id);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public SpeechLog load(Serializable id, LockOptions lockOptions) throws DataAccessException {
		try {
			return (SpeechLog)getSession().load(SpeechLog.class, id, lockOptions);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void load(SpeechLog entity, Serializable id) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(SpeechLog entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void refresh(SpeechLog entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public boolean contains(SpeechLog entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void evict(SpeechLog entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void lock(SpeechLog entity, LockOptions lockOptions) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable save(SpeechLog entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(SpeechLog.class.getName(), entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void update(SpeechLog entity) throws DataAccessException {
		try {
			getSession().update(SpeechLog.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(SpeechLog entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(SpeechLog.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdate(Collection<SpeechLog> entities) throws DataAccessException {
		try {
			for(SpeechLog entity : entities) {
				getSession().saveOrUpdate(SpeechLog.class.getName(), entity);
			}
			flush();
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void persist(SpeechLog entity) throws DataAccessException {
		try {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public SpeechLog merge(SpeechLog entity) throws DataAccessException {
		try {
			SpeechLog returnObj = (SpeechLog)getSession().merge(entity);
			flush();
			return returnObj;
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	...
	public void delete(Serializable id) throws DataAccessException {
		try {
			getSession().delete(SpeechLog.class.getName(), get(id));
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void delete(SpeechLog entity) throws DataAccessException {
		try {
			getSession().delete(SpeechLog.class.getName(), entity);
			flush();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAll(Collection<SpeechLog> entities) throws DataAccessException {
		try {
			for(SpeechLog entity : entities) {
				getSession().delete(SpeechLog.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public Serializable saveNoFlush(SpeechLog entity) throws DataAccessException {
		try {
			Serializable returnObj = getSession().save(SpeechLog.class.getName(), entity);
			return returnObj;
		} catch (Exception ex) {
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void updateNoFlush(SpeechLog entity) throws DataAccessException {
		try {
			getSession().update(SpeechLog.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(SpeechLog entity) throws DataAccessException {
		try {
			getSession().saveOrUpdate(SpeechLog.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void saveOrUpdateNoFlush(Collection<SpeechLog> entities) throws DataAccessException {
		try {
			for(SpeechLog entity : entities) {
				getSession().saveOrUpdate(SpeechLog.class.getName(), entity);
			}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteNoFlush(SpeechLog entity) throws DataAccessException {
		try {
			getSession().delete(SpeechLog.class.getName(), entity);
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public void deleteAllNoFlush(Collection<SpeechLog> entities) throws DataAccessException {
		try {
			for(SpeechLog entity : entities) {
				getSession().delete(SpeechLog.class.getName(), entity);
			}
	 ...
	 * @return SpeechLog リスト
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<SpeechLog> findByMap(String queryString, Map<String,Object> paramMap) throws DataAccessException {
		try {
			return applyNamedParameter(createQuery(queryString, SpeechLog.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	 ...
	 * @throws DataAccessException Hibernate のデータアクセスException
	 */
	public List<SpeechLog> findByNamedQueryAndMap(String queryName, Map<String,Object> paramMap)
			throws DataAccessException {
		try {
			return applyNamedParameter(createNamedQuery(queryName, SpeechLog.class), paramMap).getResultList();
		} catch (Exception ex) {
			throw DaoException.handleDBException(ex);
		}
	}
	...
	public List<SpeechLog> findByExample(Object exampleEntity) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(SpeechLog.class).getExecutableCriteria(getSession())
	 ...
	 */
	@SuppressWarnings( "unchecked" )
	public List<SpeechLog> findByExample(Object exampleEntity, int firstResult, int maxResults) throws DataAccessException {
		try {
			return DetachedCriteria.forClass(SpeechLog.class).getExecutableCriteria(getSession())
				.add(Example.create(exampleEntity))
	...
	protected Criteria createCriteria() {
		Criteria criteria = DetachedCriteria.forClass(SpeechLog.class).getExecutableCriteria(getSession());
